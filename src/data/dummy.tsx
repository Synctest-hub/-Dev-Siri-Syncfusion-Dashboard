...
import type {
  ...
  CustomerGridStatusProps,
  GridEmployeeCountryProps,
  GridEmployeeProfileProps,
  GridOrderImageProps,
  GridOrderStatusProps,
} from "../types";
...
const AiOutlineCalendar = lazy(() => import("../icons/AiOutlineCalender"));
const AiOutlineShoppingCart = lazy(() => import("../icons/AiOutlineShoppingCart"));
const AiOutlineAreaChart = lazy(() => import("../icons/AiOutlineAreaChart"));
const AiOutlineBarChart = lazy(() => import("../icons/AiOutlineBarChart"));
const AiOutlineStock = lazy(() => import("../icons/AiOutlineStock"));
const FiShoppingBag = lazy(() => import("../icons/FiShoppingBag"));
const FiEdit = lazy(() => import("../icons/FiEdit"));
const FiPieChart = lazy(() => import("../icons/FiPieChart"));
const FiBarChart = lazy(() => import("../icons/FiBarChart"));
const FiCreditCard = lazy(() => import("../icons/FiCreditCard"));
const FiStar = lazy(() => import("../icons/FiStar"));
const FiShoppingCart = lazy(() => import("../icons/FiShoppingCart"));
const BsKanban = lazy(() => import("../icons/BsKanban"));
const BsBarChart = lazy(() => import("../icons/BsBarChart"));
const GiCardboardBox = lazy(() => import("../icons/GiCardboardBox"));
const BiDollar = lazy(() => import("../icons/BiDollar"));
const BsShield = lazy(() => import("../icons/BsShield"));
const BsChat = lazy(() => import("../icons/BsChat"));
const BiColorFill = lazy(() => import("../icons/BiColorFill"));
const IoMdContacts = lazy(() => import("../icons/IoMdContacts"));
const RiContactsLine = lazy(() => import("../icons/RiContactsLine"));
const RiStockLine = lazy(() => import("../icons/RiStockLine"));
const BsPeopleFill = lazy(() => import("../icons/BsPeopleFill"));
const HiOutlineRefresh = lazy(() => import("../icons/HiOutlineRefresh"));
const TiTick = lazy(() => import("../icons/TiTick"));
const GiLouvrePyramid = lazy(() => import("../icons/GiLouvrePyramid"));
const GrLocation = lazy(() => import("../icons/GrLocation"));

export const gridOrderImage: FC<GridOrderImageProps> = ({ ProductImage }) => (
  <img src={ProductImage} alt="order-item" height={80} width={80} className="rounded-xl md:ml-3" />
);

export const gridOrderStatus: FC<GridOrderStatusProps> = ({ StatusBg, Status }) => (
  <button type="button" style={{ background: StatusBg }} className="text-white py-1 px-2 capitalize rounded-2xl text-md">
    {Status}
  </button>
);
...
const gridEmployeeProfile: FC<GridEmployeeProfileProps> = ({ EmployeeImage, Name }) => (
  <div className="flex items-center gap-2">
    <img src={EmployeeImage} alt="employee" height={40} width={40} className="rounded-full" />
    <p>{Name}</p>
  </div>
);

const gridEmployeeCountry: FC<GridEmployeeCountryProps> = ({ Country }) => (
...
export const EditorData: FC = () => (
  <h3>
    Try React React has been designed from the start for gradual adoption, and you can use as little or as much React as you need. Whether you want to
    get a taste of React, add some interactivity to a simple HTML page, or start a complex React-powered app, the links in this section will help you
    get started. Online Playgrounds If you’re interested in playing around with React, you can use an online code playground. Try a Hello World
    template on CodePen, CodeSandbox, or Stackblitz. If you prefer to use your own text editor, you can also download this HTML file, edit it, and
    open it from the local filesystem in your browser. It does a slow runtime code transformation, so we’d only recommend using this for simple demos.
    Add React to a Website You can add React to an HTML page in one minute. You can then either gradually expand its presence, or keep it contained to
    a few dynamic widgets. Create a New React App When starting a React project, a simple HTML page with script tags might still be the best option.
    It only takes a minute to set up! As your application grows, you might want to consider a more integrated setup. There are several JavaScript
    toolchains we recommend for larger applications. Each of them can work with little to no configuration and lets you take full advantage of the
    rich React ecosystem. Learn how. Learn React People come to React from different backgrounds and with different learning styles. Whether you
    prefer a more theoretical or a practical approach, we hope you’ll find this section helpful. If you prefer to learn by doing, start with our
    practical tutorial. If you prefer to learn concepts step by step, start with our guide to main concepts. Like any unfamiliar technology, React
    does have a learning curve. With practice and some patience, you will get the hang of it. First Examples The React homepage contains a few small
    React examples with a live editor. Even if you don’t know anything about React yet, try changing their code and see how it affects the result.
    React for Beginners If you feel that the React documentation goes at a faster pace than you’re comfortable with, check out this overview of React
    by Tania Rascia. It introduces the most important React concepts in a detailed, beginner-friendly way. Once you’re done, give the documentation
    another try! React for Designers If you’re coming from a design background, these resources are a great place to get started. JavaScript Resources
    The React documentation assumes some familiarity with programming in the JavaScript language. You don’t have to be an expert, but it’s harder to
    learn both React and JavaScript at the same time. We recommend going through this JavaScript overview to check your knowledge level. It will take
    you between 30 minutes and an hour but you will feel more confident learning React.
  </h3>
);

const customerGridImage: FC<CustomerGridImageProps> = ({ CustomerImage, CustomerName, CustomerEmail }) => (
  <div className="image flex gap-4">
    <img src={CustomerImage} alt="employee" height={40} width={40} className="rounded-full" />
    <div>
      <p>{CustomerName}</p>
      <p>{CustomerEmail}</p>
    </div>
...
const customerGridStatus: FC<CustomerGridStatusProps> = ({ StatusBg, Status }) => (
