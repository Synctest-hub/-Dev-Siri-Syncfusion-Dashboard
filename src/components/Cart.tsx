...
import AiOutlineMinus from "../icons/AiOutlineMinus";
import AiOutlinePlus from "../icons/AiOutlinePlus";
import MdCancel from "../icons/MdCancel";
          ...
          <div key={index}>
            <div>
              <div className="flex items-center leading-8 gap-5 border-b-1 border-color dark:border-gray-600 p-4">
                <img src={item.image} alt="Cart Image" height={80} width={96} className="rounded-lg" />
                <div>
