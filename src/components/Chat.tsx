...
const Chat: FC = () => (
  <article className="nav-item absolute right-5 md:right-52 top-16 bg-white dark:bg-[#42464D] p-8 rounded-lg w-96">
    ...
    <div className="mt-5 ">
      ...
      <div className="mt-5">
        <Button color="white" useThemeBgColor text="See all messages" borderRadius="10px" width="full" />
      </div>
    </div>
  </article>
);
