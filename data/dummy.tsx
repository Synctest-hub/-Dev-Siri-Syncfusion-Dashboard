...
import { RiStockLine } from "@react-icons/all-files/ri/RiStockLine";
...
export const gridOrderImage: FC<GridOrderImageProps> = ({ ProductImage }) => (
  <Image src={ProductImage} alt="order-item" height={80} width={80} className="rounded-xl md:ml-3" />
);
...
const gridEmployeeProfile: FC<GridEmployeeProfileProps> = ({ EmployeeImage, Name }) => (
  <div className="flex items-center gap-2">
    <Image src={EmployeeImage} alt="employee" height={40} width={40} className="rounded-full" />
    <p>{Name}</p>
  </div>
);
...
const customerGridImage: FC<CustomerGridImageProps> = ({ CustomerImage, CustomerName, CustomerEmail }) => (
  <div className="image flex gap-4">
    <Image src={CustomerImage} alt="employee" height={40} width={40} className="rounded-full" />
    <div>
      <p>{CustomerName}</p>
      <p>{CustomerEmail}</p>
    </div>
